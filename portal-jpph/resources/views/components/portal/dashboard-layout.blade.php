...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        ...
        @if (auth()->user()?->canManageContent())
            <a href="/admin/case-duti-setems" class="nav-a">
            ...
            <a href="/admin/case-pinjaman-perumahans" class="nav-a">
            ...
            <a href="/admin/pages" class="nav-a">
                <span class="nav-ic"><svg width="15" height="15" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"/></svg></span>
                <span>{{ __('Halaman Statik') }}</span>
            </a>

            <a href="/admin/announcements" class="nav-a">
                <span class="nav-ic"><svg width="15" height="15" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 3a1 1 0 00-1.447-.894L8.763 6H5a3 3 0 000 6h.28l1.771 5.316A1 1 0 008 18h1a1 1 0 001-1v-4.382l6.553 3.276A1 1 0 0018 15V3z" clip-rule="evenodd"/></svg></span>
                <span>{{ __('Hebahan') }}</span>
            </a>

            <a href="/admin/faqs" class="nav-a">
                <span class="nav-ic"><svg width="15" height="15" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1.5 1.5 0 00-1.341.834.75.75 0 11-1.342-.67A3 3 0 0110 5c1.657 0 3 1.343 3 3 0 1.243-.756 2.31-1.832 2.769l-.085.036A.75.75 0 019.5 10a.75.75 0 01.585-1.323A1.5 1.5 0 1010 5z" clip-rule="evenodd"/></svg></span>
                <span>{{ __('Soalan Lazim') }}</span>
            </a>
        @else
            <span class="nav-a is-disabled" data-tip="{{ __('Hubungi pentadbir untuk akses') }}">
